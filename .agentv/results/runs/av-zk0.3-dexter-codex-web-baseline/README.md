...
- Source artifacts copied from a local live-run workspace before publication; the local workspace path is intentionally not published.
...
- [`docs/dexter-baseline.html`](../../../../docs/dexter-baseline.html) renders this baseline as a read-only, Dashboard-style AgentV report suitable for GitHub Pages.
